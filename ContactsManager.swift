...
//        return Static.instance
    ...
    //获取本地权限状态
    static func getLocalContactSaveType()->Bool{
...
//                        if let bit = contact.birthday?.calendar?.dateFromComponents((contact.birthday)!){
//                            let formate = NSDateFormatter()
//                            formate.dateFormat = "yyyy-MM-dd HH:mm"
//                            let date = formate.stringFromDate(bit)
//                            model.birthday = date
//                        }
//                    }
                    //名字
...
//        //公司地址
//        var company = [CNLabeledValue]()
//        let address = CNMutablePostalAddress.init()
//        address.city = model.location ?? " "
